  ...
  return (
    ...
    >
      ...
      <div className="mb-10 sm:mb-12">
        ...
        >
          If you have questions, we have answers for you here. In case we don't,
          please feel free to reach out to us at contact@liinn.com
        </p>
      </div>
        ...
        <div className="space-y-1">
          {faqs.map((faq, index) => (
            ...
            >
              <button
                onClick={() => toggle(index)}
                className={`w-full flex justify-between items-center py-4 sm:py-6 text-left transition-colors ${
              ...
              {openIndex === index && (
                <div
                  className={`pb-4 sm:pb-6 text-sm sm:text-base leading-relaxed ${
                    isDarkMode ? "text-gray-400" : "text-gray-600"
                  }`}
                >
                  {faq.answer}
